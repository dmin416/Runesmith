...
| **9.5** | Three-month Carwen grind (month beats) | Matched-level goblins + spell rank XP. Rough ends: **M1 ~L11–12**, **M2 ~L16–17**, **M3 → L20**. Kill-only yardstick ~**1,481** matched goblins (~16–17/day over ~90 days); spell popups cut real kill need |
...
| 9.5 | Month 1–3 Carwen forest (matched goblins + spell XP) | ~L11–12 / ~L16–17 / **L20** | Arrow unlock late M1; Shield through mid teens in M2; Goblin Hunter in M3; spell ranks bank extra XP beyond ears |
| 10 | Present after timeskip | at **L20** | Inn sheet + nest opener; plans last five to Mage cap then Mana Scrybe / Edelgard |
