...
### Linear conversion (stat to real output)
...
No cap on S. Each point of the attribute scales that real measure by k.

| Stat | Real measure | k (per stat point) | Untrained adult (S = 15) | Sickly 5-year-old |
|---|---|---|---|---|
| STR | Max deadlift | 6 kg | 90 kg | S 4 = 24 kg |
| VIT | Natural lifespan | 3 years | 45 years | S 4 = 12 years |
| END | VO2 max | 0.2 L/min | 3 L/min | S 4 = 0.8 L/min |
| AGI | Sprint speed | 0.4 m/s | 6 m/s | S 8 = 3.2 m/s |
| DEX | Pegboard pegs (right hand) | 1 peg | 15 pegs | S 8 = 8 pegs |
| INT | Working memory (digit span) | 0.5 digits | 7.5 digits | see mental track |
| WILL | Effective life experience | 2 years | 30 years | see mental track |
...
Same k formula on the age table:
...
| AGI | Sprint speed | 3.2 m/s | 6.8 m/s | 8.8 m/s | 9.6 m/s |
| DEX | Pegboard pegs (right hand) | 8 pegs | 16 pegs | 19 pegs | 21 pegs |

Late teens on this track read as serious athletes versus the untrained adult at S = 15. Replace or curve later if high-tier class sheets break immersion.
